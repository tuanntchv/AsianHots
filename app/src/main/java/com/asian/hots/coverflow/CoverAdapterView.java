...
import android.widget.Adapter;
	...
	public abstract class CoverAdapterView<T extends Adapter> extends ViewGroup {
	    ...
	    public CoverAdapterView(Activity context) {
	        super(context);
	        mActivity = context;
	    }

	    public CoverAdapterView(Activity context, AttributeSet attrs) {
	        super(context, attrs);
	        mActivity = context;
	    }

	    public CoverAdapterView(Activity context, AttributeSet attrs, int defStyle) {
	    ...
	    public int getSelectedItemPosition() {
	    	if(GlobalVariable.SELECTPOSITION)
	    	{
		    	if(mNextSelectedPosition != countSelection)
		    	{
		    		((CoverFlowActivity)mActivity).setSeekBar(mNextSelectedPosition);
		    		countSelection = mNextSelectedPosition;
		    		GlobalVariable.IMAGESELECT = mNextSelectedPosition;
		    	}
	    	}
