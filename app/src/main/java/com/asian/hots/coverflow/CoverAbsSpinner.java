...
import android.widget.SpinnerAdapter;
	...
	public abstract class CoverAbsSpinner  extends CoverAdapterView<SpinnerAdapter> {
	    ...
	    public CoverAbsSpinner(Activity context) {
	        super(context);
	        initAbsSpinner();
	    }

	    public CoverAbsSpinner(Activity context, AttributeSet attrs) {
	        this(context, attrs, 0);
	    }

	    public CoverAbsSpinner(Activity context, AttributeSet attrs, int defStyle) {
